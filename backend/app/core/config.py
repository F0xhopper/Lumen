...
class Settings:
    ...
    PINECONE_INDEX_NAME: str = os.getenv("PINECONE_INDEX_NAME", "aquinas-works-testing-page-number")
    PINECONE_NAMESPACE: Optional[str] = os.getenv("PINECONE_NAMESPACE", "").strip() or None
